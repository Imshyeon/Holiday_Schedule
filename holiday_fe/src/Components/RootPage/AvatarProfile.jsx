...
export default function AvatarProfile() {
  ...
  return (
    <>
      <div className="absolute z-10 mt-auto right-0 bg-white border border-sky-100 px-5 py-3 rounded-2xl min-w-52 h-fit text-center flex flex-col items-center">
        <Link to="user">
          <img
